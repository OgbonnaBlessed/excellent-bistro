...
const SpecialOffer = () => {
    ...
    // FETCH MENU
    useEffect(() => {
        axios.get('https://excellent-bistro.onrender.com/api/items')
        ...
        <div className='bg-gradient-to-b from-[#1A1212] to-[#2A1E1E] text-white py-16 px-4 font-[Poppins]'>
            <div className='max-w-7xl mx-auto'>
                            ...
                            >
                                <div className='relative h-72 overflow-hidden'>
                                    ...
                                    <div className='absolute bottom-4 left-4 right-4 flex justify-between items-center bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full'>
                                        <span className='flex items-cente gap-2 text-amber-400'>
                                ...
                                <div className='absolute inset-0 rounded-3xl pointer-events-none border-none border-2 border-transparent group-hover:border-amber-500/30 transition-all duration-500' />
                ...
                <div className='mt-12 flex justify-center'>
                    ...
                    >
                        <div className='absolute inset-0 bg-gradient-to-r fill-amber-500/20 via-transparent to-amber-50/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
